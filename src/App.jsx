          ...
          <ul className="social-links">
            <li>
              <a href="https://t.me/fuck4g" target="_blank" rel="noreferrer">
                ...
                <span className="type-text">high-tier student</span>
            ...
            <li>
              <a href="https://discord.gg/RKdfckR8" target="_blank" rel="noreferrer">
                ...
                <span className="type-text">&&;:/-902</span>
                <span id="discord-status" className="status-online">[online]</span>
              </a>
              <div id="discord-activity" className="discord-activity"></div>
            </li>
            ...
            <li>
              <a href="https://github.com/xyp9r" target="_blank" rel="noreferrer">
                ...
                <span className="type-text">xyp9r</span>
                <span className="status-online-fake">[hard work]</span>
              </a>
            </li>
            ...
            <li> 
              <a href="mailto:sirenko.ivan77@gmail.com" id="email-link">
                ...
                <span id="email-text" className="type-text">i@v4mp.eu</span>
